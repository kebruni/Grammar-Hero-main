...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-[24px] border-border border bg-card p-2 no-underline shadow-sm transition-colors hover:bg-card/60 ',
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn('text-lg  my-2 font-semibold leading-tight px-1', className)}
    {...props}
  />
))
